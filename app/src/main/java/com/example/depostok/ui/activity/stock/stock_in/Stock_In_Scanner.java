...
public class Stock_In_Scanner extends Activity implements DecoratedBarcodeView.TorchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnListIn = findViewById(R.id.btnListIn);
        btnListIn.setOnClickListener(v -> {
            startActivity(new Intent(Stock_In_Scanner.this, Stock_In.class));
            finishAndRemoveTask();
        });
    }
